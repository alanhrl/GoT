...
import com.example.got.databinding.ActivityLoginBinding
...
class Login : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding){
            ...
            binding.btnRegister.setOnClickListener {
                if(!validaCampos()) return@setOnClickListener
                registraUsuario(email, pass)
            }

            binding.tvRestPass.setOnClickListener {
    ...
    private fun validaCampos(): Boolean{
        ...
        pass = binding.tietPass.text.toString().trim()
        ...
        if(pass.isEmpty() || pass.length < 6){
            binding.tietPass.error = "Se requiere una contraseña o la contraseña no tiene por lo menos 6 caracteres"
    ...
    private fun manejaErrores(task: Task<AuthResult>){
        ...
        when(errorCode){
            ...
            "ERROR_WRONG_PASSWORD" -> {
                ...
                binding.tietPass.error = "La contraseña no es válida"
                binding.tietPass.requestFocus()
            ...
            "ERROR_WEAK_PASSWORD" -> {
                ...
                binding.tietPass.error = "La contraseña debe de tener por lo menos 6 caracteres"
                binding.tietPass.requestFocus()
            }
            "NO_NETWORK" -> {
